...
function SlideContent() {
    ...
    const slideContent = [
        ...
        { id: 11, icon: "🍬", title: "مشاعر بدون مناسبة", subtitle: "بتجيلك لحظة فجأة وتلاقي نفسك بتفتكر حد.. من غير سبب.. بس الشعور دافي" },
    ];
    ...
    return (
        <div className='container'>
            ...
            >
                ...
                <h2>كأن في وعد</h2>
                <p>في حاجة جواك دايمًا بتطمنك إن في روح معينة مكانها في حياتك مهما حصل.</p>
